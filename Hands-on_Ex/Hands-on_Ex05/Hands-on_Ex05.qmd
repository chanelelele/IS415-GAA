...
-   To apply appropriate spatial statistical methods to discover if development are even distributed geographically.
...
### 9.3.1 Import csv file into r environment
...
### 9.3.2 Import shapefile into r environment
...
### 9.7.1 Computing Moran’s I correlogram
...
Computing global spatial autocorrelation statistics and to perform spatial complete randomness test for global spatial autocorrelation.
